...
valid.keys    <- cbind(data.frame(HashID      = valid.hash),
                       valid.keys,
                       data.frame(CreatedDate = as.Date("2016-11-03"),
                                  CreatedByUserID = "lukasz.bednarz",
                                  FileName    = "trade_store_1984_4454_Buy_LB_TEST_2016-03-29_objectstore_2016-11-03_lukasz.bednarz.rds"))
...
valid.ret     <- data.frame(sHashID    = valid.hash,
                            ...
                            sLegStatus     = "Closed",
                            dtCreatedDate = as.Date("2016-11-03"),
                            sCreatedByUserID = "lukasz.bednarz",
                            sFileName  = "trade_store_1984_4454_Buy_LB_TEST_2016-03-29_objectstore_2016-11-03_lukasz.bednarz.rds",
                            stringsAsFactors = FALSE)
