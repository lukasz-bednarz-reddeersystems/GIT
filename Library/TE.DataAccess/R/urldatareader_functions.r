#' Convert xml document body to matrix
#'
#' Conversion of XMLDocument to a matrix given specified and column
#' names assumes that data is not ragged, is 2d and is uniformly numeric.
#'
#' @param columns character vector with column names of the new matrix
#' @param types character vector with classes of output columns
#' @param obj_xml_document_body character body of XML document
#' @return \code{rval} matrix with new data from converted xml
...
#' Convert xml document body to matrix
#'
#' Conversion of XMLDocument to a data.frame given specified column
#' names and types. Assumes that data is 2d.
#'
#' @param columns character vector with column names of the new matrix
#' @param types character vector with classes of output columns
#' @param obj_xml_document_body character body of XML document
