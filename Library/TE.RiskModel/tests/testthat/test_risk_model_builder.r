context("Testing Risk Model Builder Classes")

##############################################
#
# VirtualRiskModelBuilder Tests
#
##############################################
tested.class          <-  "VirtualRiskModelBuilder"
...
##############################################
#
# RiskModelBuilder Tests
#
##############################################
tested.class          <- "RiskModelBuilder"
