...
#' Offside Positions Reference Data class.
#'
#' Concrete S4 class storing data of Offside Market Positions.
#' Generated only by OffsidePositionsAnalysisBlock module.
#'
...
setMethod("dataRequest",
          ...
          function(object, key_values){
            ...
            price_key_vals <- expand.grid(InstrumentID = instruments, Date = dates)
            ...
            object <- TE.RefClasses:::.setMarketDataObject(object, index_rd)
