context("Testing BuysAndSellsAnalysisBlock")


##################################
#
# BuysAndSellsAnalysisBlock Tests
#
##################################
...
# test vectors
tested.class          <-  "BuysAndSellsAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getTradeDataObject(object), "ExtendedTradeData")
