context("Testing PortfolioHedgeInstrumentCoreFactorsMCTRAnalysisBlock")

########################################################
#
# PortfolioHedgeInstrumentCoreFactorsMCTRAnalysisBlock Tests
#
########################################################
tested.class          <-  "PortfolioHedgeInstrumentCoreFactorsMCTRAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getOutputObject(object), "PortfolioHedgeInstrumentCoreFactorsMCTRData")
...
test_that("Can dataRequest() with valid key_values", {
  ...
  valid.key_values <- dated_one_monthly_lookback(11, "2016-11-30")
...
test_that(paste("Can Process() on", tested.class), {
  ...
  valid.key_values <- dated_one_monthly_lookback(101, "2016-11-30")
  ...
  expect_is(output, "PortfolioHedgeInstrumentCoreFactorsMCTRData")
