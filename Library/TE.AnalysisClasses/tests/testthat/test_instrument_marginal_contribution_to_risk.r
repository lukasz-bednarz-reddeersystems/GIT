context("Testing PortfolioInstrumentMCTRAnalysisBlock")

########################################################
#
# PortfolioInstrumentMCTRAnalysisBlock Tests
#
########################################################
tested.class          <-  "PortfolioInstrumentMCTRAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getOutputObject(object), "PortfolioInstrumentMCTRData")
