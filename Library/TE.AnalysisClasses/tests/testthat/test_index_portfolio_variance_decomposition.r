...
#
########################################################
tested.class          <-  "IndexPortfolioVarianceDecompositionAnalysisBlock"
...
test_that("Can dataRequest() with valid key_values", {
  ...
  valid.key_values <- dated_three_monthly_lookback(valid.ticker, "2016-06-30")
...
test_that(paste("Can Process() on", tested.class), {
  ...
  #valid.key_values <- dated_eighteen_monthly_lookback(valid.ticker, '2016-07-01')
