context("Testing PortfolioCoreFactorHedgeReturnsAnalysisBlock")


##############################################
#
# PortfolioCoreFactorHedgeReturnsAnalysisBlock Tests
#
##############################################
# pre computed data
...
# test vectors
tested.class          <-  "PortfolioCoreFactorHedgeReturnsAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getOutputObject(object), "PortfolioCoreFactorHedgeReturnsData")
...
test_that(paste("Can Process() on", tested.class), {
  ...
  expect_is(output, "PortfolioCoreFactorHedgeReturnsData")
