context("Testing StrategyBreakdownPnLOnTradeDayPerSignalAnalysisBlock")

############################################################
#
# StrategyBreakdownPnLOnTradeDayPerSignalAnalysisBlock Tests
#
############################################################
# get required data
...
# test vectors
tested.class <- "StrategyBreakdownPnLOnTradeDayPerSignalAnalysisBlock"
