context("Testing PositionsHoldingCapitalDistributionAnalysisBlock")

########################################################
#
# PositionsHoldingCapitalDistributionAnalysisBlock Tests
#
########################################################
...
# test vectors
tested.class          <-  "PositionsHoldingCapitalDistributionAnalysisBlock"
