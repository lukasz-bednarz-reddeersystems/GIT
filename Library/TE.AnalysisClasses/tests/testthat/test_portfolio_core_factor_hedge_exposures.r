context("Testing PortfolioCoreFactorHedgeExposuresAnalysisBlock")

#############################################
#
# PortfolioCoreFactorHedgeExposuresAnalysisBlock Tests
#
#############################################
# pre computed data
...
# test vectors
tested.class          <-  "PortfolioCoreFactorHedgeExposuresAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getOutputObject(object), "PortfolioCoreFactorHedgeExposuresData")
...
test_that(paste("Can Process() on", tested.class), {
  ...
  expect_is(output, "PortfolioCoreFactorHedgeExposuresData")
