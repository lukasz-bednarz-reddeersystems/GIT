context("Testing PortfolioCoreFactorExposuresAnalysisBlock")

#############################################
#
# PortfolioCoreFactorExposuresAnalysisBlock Tests
#
#############################################
# pre computed data
...
# test vectors
tested.class          <-  "PortfolioCoreFactorExposuresAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getOutputObject(object), "PortfolioCoreFactorExposuresData")
...
test_that(paste("Can Process() on", tested.class), {
  ...
  expect_is(output, "PortfolioCoreFactorExposuresData")
