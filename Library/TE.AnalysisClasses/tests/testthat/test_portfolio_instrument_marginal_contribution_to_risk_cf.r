context("Testing PortfolioInstrumentCoreFactorsMCTRAnalysisBlock")

########################################################
#
# PortfolioInstrumentCoreFactorsMCTRAnalysisBlock Tests
#
########################################################
tested.class          <-  "PortfolioInstrumentCoreFactorsMCTRAnalysisBlock"
...
test_that(paste("Can use basic accessors of ", tested.class, "object"), {
  ...
  expect_is(getOutputObject(object), "PortfolioInstrumentCoreFactorsMCTRData")
...
test_that(paste("Can Process() on", tested.class), {
  ...
  expect_is(output, "PortfolioInstrumentCoreFactorsMCTRData")
