...
#####################################################
#
# OffsidePositionsCumulativePnLAnalysisBlock Tests
#
#####################################################
...
# test vectors
tested.class          <-  "OffsidePositionsCumulativePnLAnalysisBlock"
...
test_that(paste("Can Process() on", tested.class), {
  ...
  expect_is(outp, "OffsidePositionCumulativePnLData")
