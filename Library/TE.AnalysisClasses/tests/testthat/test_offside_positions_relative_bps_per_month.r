context("Testing OffsidePositionsBpsPerMonthAnalysisBlock")

###############################################
#
# OffsidePositionsBpsPerMonthAnalysisBlock Tests
#
###############################################
...
# test vectors
tested.class          <-  "OffsidePositionsBpsPerMonthAnalysisBlock"
...
test_that(paste("Can Process() on", tested.class), {
  ...
  expect_is(outp, "OffsidePositionRelativeBpsData")
