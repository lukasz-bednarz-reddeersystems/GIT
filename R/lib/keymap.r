#generates the values for each field to be 
#retrieved from the data layer
#also maps the URL field names to the XML variable names, 
#output data.frame column names should match the names of the 
#query fields in the middle layer URL
#cols[1] is the name of the ID column
#cols[2] is the name of the date column
...
#Handles the relationship between queries for missing data rows and the 
#values of the URL fields that obtain that data
setClass(
  Class          = "KeyMap",
